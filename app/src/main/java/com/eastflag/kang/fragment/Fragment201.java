 ...
 * 모임 수정
 */
public class Fragment201 extends DialogFragment {
    ...
    public static Fragment201 newInstance(String m_id, String moim_name, String adm_name, String adm_email) {
        Fragment201 frag = new Fragment201();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        mView = View.inflate(getActivity(), R.layout.fragment_200, null);
